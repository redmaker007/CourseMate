...
| 前端 | 统一会话、课程流程、Profile onboarding、好友后端（#11–#14）已合并进 `main`，**已部署上线**（2026-09-10，`38b0636`）。未登录冒烟通过：登录页列出两所学校，受保护页面全部跳转登录，无 500 |
...
> 该分支已于 2026-09-10 删除（提交 `ff5b596`），其 schema 已被 `main` 上的 `202609070001` / `202609070002` 重写取代。以下为历史记录。
